...
import { CreateRecruiterFeedbackDto, UpdateRecruiterFeedbackDto } from '../dtos/recruiter-feedback.dto';
  ...
  export class RecruiterFeedbackController {
    constructor(private readonly recruiterFeedbackService: RecruiterFeedbackService) {}
    ...
    async getMyFeedbacks(
      ...
      return this.recruiterFeedbackService.getRecruiterFeedbacksByCandidate(user.sub, {
        page,
        limit,
      });
    }
