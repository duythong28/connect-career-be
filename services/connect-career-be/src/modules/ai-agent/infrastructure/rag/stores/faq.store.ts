...
@Injectable()
export class FaqStore implements VectorStore {
  private readonly logger = new Logger(FaqStore.name);
  ...
  async addDocuments(chunks: DocumentChunk[]): Promise<void> {
    ...
    this.logger.log(`Added ${chunks.length} FAQ documents to store`);
  }
